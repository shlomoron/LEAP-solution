...
4. In block 37, load the last part checkpoints by:  
  ...
  The weights used for inference are give [here for the low-res models](https://www.kaggle.com/datasets/shlomoron/leap-model-weights-lr) and [here for the high-res models](https://www.kaggle.com/datasets/shlomoron/leap-model-weights-hr), and for each model in the following list I link also an inference notebook. Finally, [this notebook](https://www.kaggle.com/code/shlomoron/leap-preds-validation) show that the predictions obtained in the given inference notebook are the same as the predictions used in my winning ensemble.
  1. 0p0-all30epochs: Trained only on low-res data, 3 epochs. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-0p0-3epochs-e30-inference-p)  
  2. 0p0-all60epochs: Trained only on low-res data, 6 epochs. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-0p0-6epochs-e60-inference-p)  
  3. 0p0-all90epochs ensemble-2: Trained only on low-res data, 9 epochs. An equal-eweights sub-ensemble of the predictions with the model weights from sub-epoch 58 and sub-epoch 90 (last). [inference notebook for sub-epoch 58](https://www.kaggle.com/code/shlomoron/leap-0p0-9epochs-e58-inference-p), [inference notebook for sub-epoch 90](https://www.kaggle.com/code/shlomoron/leap-0p0-9epochs-e90-inference-p).  
  4. lr-0p0-4e-512dim: Trained only on low-res data, 4 epochs, model dim 512, prediction head dim 2048, no spacetime auxiliary loss. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-0p0-512dim-nost-4epochs-e40-inference)  
  5. lr-0p0-3e-384dim: Trained only on low-res data, 3 epochs, no spacetime auxiliary loss. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-0p0-384dim-nost-3epochs-e30-inference-p)  
  6. hr-0p0-4e: Trained on low-res+high-res data. 4 epochs. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-hr-0p0-4epochs-e40-inference-p)  
  7. 0p0-4e-256dim-fr: Trained on low-res+high-res data. 4 epochs. Model dimensions 256. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-hr-0p0-256dim-4epochs-fr-e40-inference-p)  
  8. hr-0p0-3e: Trained on low-res+high-res data. 3 epochs. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-hr-0p0-3epochs-e30-inference-p)  
  9. hr-0p0-7e-256dim: Trained on low-res+high-res data. 7 epochs. Model dimensions 256. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-hr-0p0-256dim-7epochs-e70-inference-p)  
  10. 0p0-4e-no-aux: Trained on low-res+high-res data. 4 epochs. no spacetime auxiliary loss. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-hr-0p0-noaux-4epochs-e40-inference-p)  
  11. 0p0-5e-nospacetime: Trained on low-res+high-res data. 5 epochs. no spacetime auxiliary loss. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-hr-0p0-nospacetime-5epochs-e50-inference-p)  
  12. hr-0p0-5e-noconfidencehead: Trained on low-res+high-res data. 5 epochs. no spacetime auxiliary loss. No confidence head. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-hr-0p0-noconfidenceh-5epochs-e50-inference-p)
  13. hr-0p0-3e-nospacetime: Trained on low-res+high-res data. 3 epochs. no spacetime auxiliary loss. [inference notebook](https://www.kaggle.com/code/shlomoron/leap-hr-0p0-nospacetime-3epochs-e30-inference-p)

I know that the models names does not follow the same convention and can be a bit confusing, and I am sorry about that.  
